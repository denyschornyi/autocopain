                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php
                                        $dateForHuman = $day->created_at->diffForHumans();
                                        $dateForHuman = str_replace('ago', 'passés', $dateForHuman);
                                        $dateForHuman = str_replace('days', 'jours', $dateForHuman);
                                        $dateForHuman = str_replace('day', 'jour', $dateForHuman);
                                        $dateForHuman = str_replace('weeks', 'semaines', $dateForHuman);
                                        ...
                                        $dateForHuman = str_replace('hours', 'Heures', $dateForHuman);
