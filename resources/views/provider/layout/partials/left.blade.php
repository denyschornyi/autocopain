<div class="col-md-3">
    <div class="dash-left">
        ...
        <div class="side-menu">
             <ul>
                <li><a class="active" href="{{ route('provider.index') }}">Acccueil</a></li>
                <li><a href="{{ route('provider.trips') }}">Mes dépannages</a></li>
                <li><a href="{{ route('provider.profile.show') }}">Profil</a></li>
                <li>
