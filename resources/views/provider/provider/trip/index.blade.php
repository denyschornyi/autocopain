...
<div class="col-md-9">
    <div class="dash-content">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title">Mes dépannages</h4>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <table class="table table-condensed" style="border-collapse:collapse;">
                    ...
                    <tbody>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mytrip-right">
                                            ...
                                            <div class="fare-break">
                                                ...
                                                <h4 class="text-center"><strong>RÉPARTITION DU PRIX</strong></h4>

                                                <h5>Prix de base <span>{{ $Job->payment ? $Job->payment->base_price : 'N/A' }}</span></h5>
                                                <h5><strong>Prix à l'heure </strong><span><strong>{{ $Job->payment ? $Job->payment->time_price : 'N/A' }}</strong></span></h5>
                        ...
                        @if(!count($Jobs))
                        <tr>
                            <td colspan="999">Aucun dépannages effectués.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
