...
<div class="pro-dashboard-head">
    <div class="container">
        <a href="{{ route('provider.profile.index') }}" class="pro-head-link">Profil</a>
        <a href="{{ route('provider.documents.index') }}" class="pro-head-link">Documents</a>
        <a href="#" class="pro-head-link active">Lieu</a>
    </div>
</div>
                        ...
                        <form action="{{ route('provider.location.update') }}" id="location_update_form" method="POST" class="form-horizontal row-border">
                            ...
                            <div class="prof-form-sub-sec border-top">
                                <div class="col-xs-12 col-md-6 col-md-offset-3">
                                    <button type="submit" class="btn btn-block btn-primary update-link">Mettre à jours</button>
                                </div>
                            </div>
                        </form>
                    </div>
