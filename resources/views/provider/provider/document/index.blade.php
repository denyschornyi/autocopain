...
<div class="pro-dashboard-head">
    <div class="container">
        ...
        <a href="#" class="pro-head-link active">Documents</a>
        <a href="{{ route('provider.location.index') }}" class="pro-head-link">Lieu</a>
    </div>
</div>
                        ...
                        <div class="manage-doc-box row no-margin border-top">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="manage-doc-box-left">
                                    ...
                                    <p class="license">Expire : {{ $Provider->document($Document->id) ? $Provider->document($Document->id)->expires_at : 'N/A' }}</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
