            ...
            <div class="box b-a-0">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="px-2 form-group mb-0">
                        <button type="submit" class="btn btn-purple btn-block text-uppercase">Envoyer le mot de passe</button>
                    </div>
                </form>
                <div class="p-2 text-xs-center text-muted">
                    <a class="text-black" href="{{ url('/admin/login') }}"><span class="underline">Se connecter</span></a>
                </div>
            </div>
        </div>
    </div>
