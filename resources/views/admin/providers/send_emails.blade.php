...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;">Envoyer des emails aux fournisseurs</h5>

            <form class="form-horizontal" action="{{URL::route('admin.provider.emailToProvider')}}" method="POST" enctype="multipart/form-data" role="form" novalidate>
                {{csrf_field()}}
