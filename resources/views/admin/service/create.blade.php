        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="name" class="col-xs-12 col-form-label">Choisir une catégorie</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="picture" class="col-xs-12 col-form-label">Icône du dépannage</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="notice" class="col-xs-12 col-form-label">Notice</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('notice') }}" name="notice" id="notice" placeholder="Notice">
                    </div>
                </div>
