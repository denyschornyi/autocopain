    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
				...
				<form action="{{route('admin.setting.store')}}" method="POST">
					...
					<div class="card card-block card-inverse card-primary text-xs-center">
						...
						<div class="row">
							<div class="col-md-5">
			                	<button class="pull-right btn btn-default mr10" type="submit">Validé</button>
							</div>
						</div>
            ...
            <form class="form-horizontal" action="{{route('admin.setting.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="daily_target" class="col-xs-2 col-form-label">Cible quotidienne</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('daily_target', '')  }}" name="daily_target" required id="daily_target" placeholder="Cible quotidienne">
					</div>
				</div>

				<div class="form-group row">
					<label for="tax_percentage" class="col-xs-2 col-form-label">Valeur de la taxe(%)</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('tax_percentage', '')  }}" name="tax_percentage"  id="tax_percentage" max="100" min="0" placeholder="Pourcentage de la taxe">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('surge_percentage', '')  }}" name="surge_percentage"  id="surge_percentage" max="100" min="0" placeholder="Augmentation">
					</div>
				</div>


				<div class="form-group row">
					<label for="commission_percentage" class="col-xs-2 col-form-label">Taux de la Commission(%)</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('commission_percentage', '')  }}" name="commission_percentage" max="100" min="0"  id="commission_percentage" placeholder="Commission">
					</div>
				</div>

				<div class="form-group row">
					<label for="base_price" class="col-xs-2 col-form-label">
						Devise ( <strong>{{ Setting::get('currency', '')  }} </strong>)
					</label>
					<div class="col-xs-10">
