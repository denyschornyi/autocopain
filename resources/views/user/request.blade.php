    ...
    <div class="dash-content">
        ...
        <div class="row no-margin">
            <div class="col-md-6">
                 ...
                 <p>@lang('user.payment_method')</p>
                    ...
                    @if(Setting::get('CARD') == 1)
                        ...
                        <select class="form-control" name="card_id" style="display: none;" id="card_id">
                          <option value="">Selectionner une carte de paiement</option>
                ...
                <button type="button" class="half-secondary-btn fare-btn" data-toggle="modal" data-target="#schedule_modal">Programmer un dépannage</button>
