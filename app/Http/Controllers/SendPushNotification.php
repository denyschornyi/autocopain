...
class SendPushNotification extends Controller
{
    ...
    /**
     * Driver Start Service at your location.
     *
     * @return void
     */
    public function StartService($request){

        return $this->sendPushToUser($request->user_id, trans('api.push.startservice'));
    }
    ...
    public function EndService($request){
        ...
        return $this->sendPushToUser($request->user_id, trans('api.push.endservice'));
    }
...
//                        ->to('4b38fe207c9d5c80b001cfcb6a5a1af01a3d7ba76cf5ff404f45cfa76fdf973e')
//                        ->send('test');
                     return \PushNotification::app('IOSUser')
