...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        try {
            ...
            return view('admin.dashboard', compact('total_commission', 'alerts', 'incomingEmails', 'newProviders', 'newUsers', 'providers', 'service', 'rides', 'cancel_rides', 'revenue'));
        } catch (Exception $e) {
    ...
    {
        $Pendinglist = WalletRequest::select(['wallet_requests.*', 'providers.first_name as first_name', 'providers.last_name as last_name'])
    ...
    public function create_transfer(Request $request)
    {
        ...
        if ($amount <= 0) {
            ...
            $WalletRequest = WalletRequest::where('from_id', Auth::user()->id)
                ...
                ->get();
            return response()->json(['success' => true, 'message' => $WalletRequest]);
        }
